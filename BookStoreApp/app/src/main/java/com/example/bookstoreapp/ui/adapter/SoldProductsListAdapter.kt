...
import com.example.bookstoreapp.ui.activities.SoldProductDetailsActivity
...
open class SoldProductsListAdapter(
    ...
    /**rrayList to a view
     *
     * Called when RecyclerView
     * Binds each item in the Aneeds a new {@link ViewHolder} of the given type to represent
     * an item.
     *
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                ...
                intent.putExtra(Constants.EXTRA_MY_ORDER_DETAIL,model)
