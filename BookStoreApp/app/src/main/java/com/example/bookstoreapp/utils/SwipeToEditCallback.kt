...
import com.example.bookstoreapp.ui.activities.AddressListActivity
import com.example.bookstoreapp.ui.fragments.ProductsFragment

abstract class SwipeToEditCallback(context: AddressListActivity) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
